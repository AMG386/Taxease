                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="fs-6">{{ $purchaseInvoice->vendor_name ?? 'Not specified' }}</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-bold">Vendor GSTIN</label>
                                <div class="fs-6">
                                    @if($purchaseInvoice->vendor_gstin)
                                        <span class="badge badge-light-primary">{{ $purchaseInvoice->vendor_gstin }}</span>
                                    @else
                            ...
                            <div class="col-12">
                                ...
                                <div class="fs-6">
                                    ...
                                    @elseif($purchaseInvoice->vendor_type == 'composition')
                                        <span class="badge badge-light-info">Composition</span>
                                    @else
